...
public class BioequivalentResponse implements Serializable {
    ...
    private List<String> productoComercial = new ArrayList<>();
    ...
    public List<String> getProductoComercial() {
        return productoComercial;
    }

    public void setProductoComercial(List<String> productoComercial) {
