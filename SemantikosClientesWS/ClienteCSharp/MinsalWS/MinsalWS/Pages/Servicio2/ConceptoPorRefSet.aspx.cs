...
{
    public partial class ConceptoPorRefSet : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = ingreso.RespuestaConceptoPorRefSet(txtNombre.Text, txtNumeroPagina.Text, txtTamañoPagina.Text);
