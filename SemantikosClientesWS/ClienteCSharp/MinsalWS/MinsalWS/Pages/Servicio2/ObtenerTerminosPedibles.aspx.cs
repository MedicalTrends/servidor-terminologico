...
{
    public partial class ObtenerTerminosPedibles : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = ingreso.RespuestaObtenerTerminosPedibles(txtNombreCategoria.Text, txtIdEstablecimiento.Text, txtNombreRefSet.Text, txtPedible.Text);
                if (respuesta != "False")
                {
