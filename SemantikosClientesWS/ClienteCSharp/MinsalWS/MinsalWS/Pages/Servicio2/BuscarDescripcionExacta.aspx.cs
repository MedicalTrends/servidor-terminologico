...
{
    public partial class BuscarDescripcionExacta : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                AccesoBusquedaWS busqueda = new AccesoBusquedaWS();
                respuesta = busqueda.RespuestaBuscarDescripcionExacta(txtIdEstableccimiento.Text, txtPattern.Text);
                if (respuesta != "False")
                {
