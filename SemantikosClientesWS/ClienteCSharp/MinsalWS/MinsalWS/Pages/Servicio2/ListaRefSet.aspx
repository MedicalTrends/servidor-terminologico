<%@ Page Title="" Language="C#" MasterPageFile="~/Servicios.Master" AutoEventWireup="true" CodeBehind="ListaRefSet.aspx.cs" Inherits="MinsalWS.Pages.Servicio2.ListaRefSet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width:100%;">
        <tr>
            <td>
                <asp:Label ID="lblIncluyeEstacionamiento" Text="Incluye estacionamiento:" runat="server"></asp:Label>
            </td>
            <td>
