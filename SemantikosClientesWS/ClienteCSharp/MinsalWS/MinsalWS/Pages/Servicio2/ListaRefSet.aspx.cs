...
{
    public partial class ListaRefSet : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = ingreso.RespuestaListaRefSet(Convert.ToBoolean(txtIncluyeEstacionamiento.Text), txtEstablecimientoNombre.Text);
                if (respuesta != "False")
                {
