...
{
    public partial class CrossMapsDirectorsPorIdDescripcion : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = ingreso.RespuestaCrossMapsDirectorsPorIdDescripcion(txtIdDescripcion.Text, txtIdConcepto.Text, txtIdEstablecimiento.Text);
                if (respuesta != "False")
                {
