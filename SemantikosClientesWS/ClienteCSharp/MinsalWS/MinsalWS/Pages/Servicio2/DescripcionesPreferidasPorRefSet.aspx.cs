...
{
    public partial class DescripcionesPreferidasPorRefSet : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = ingreso.RespuestaDescripcionesPreferidasPorRefSet(txtNombre.Text, txtNumeroPagina.Text, txtTamañoPagina.Text);
