...
{
    public partial class ConceptosRelacionados : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = busqueda.RespuestaConceptosRelacionados(txtConcepto.Text, txtDescripcionId.Text, txtCategoriaRelacion.Text);
                if (respuesta != "False")
                {
