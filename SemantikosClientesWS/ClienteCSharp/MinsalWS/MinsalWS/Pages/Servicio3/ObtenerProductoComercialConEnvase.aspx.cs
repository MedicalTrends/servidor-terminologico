...
{
    public partial class ObtenerProductoComercialConEnvase : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = busqueda.RespuestaObtenerProductoComercialConEnvase(txtConcepto.Text, txtDescripcionId.Text);
                if (respuesta != "False")
                {
