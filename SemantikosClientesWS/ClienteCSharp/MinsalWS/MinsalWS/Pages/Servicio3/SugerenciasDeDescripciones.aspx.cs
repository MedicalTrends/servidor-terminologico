...
{
    public partial class SugerenciasDeDescripciones : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = busqueda.RespuestaSugerenciasDeDescripciones(txtTermino.Text, txtNombreCat.Text, txtNombreRefSet.Text);
                if (respuesta != "False")
                {
