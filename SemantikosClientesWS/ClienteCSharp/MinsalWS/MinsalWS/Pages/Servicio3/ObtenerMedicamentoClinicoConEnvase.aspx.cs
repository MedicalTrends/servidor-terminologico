...
{
    public partial class ObtenerMedicamentoClinicoConEnvase : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = busqueda.RespuestaObtenerMedicamentoClinicoConEnvase(txtConcepto.Text, txtDescripcionId.Text);
                if (respuesta != "False")
                {
