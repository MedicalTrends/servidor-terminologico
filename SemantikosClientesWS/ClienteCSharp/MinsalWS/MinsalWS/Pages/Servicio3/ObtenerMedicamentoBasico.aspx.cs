...
{
    public partial class ObtenerMedicamentoBasico : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = busqueda.RespuestaObtenerMedicamentoBasico(txtConcepto.Text, txtDescripcionId.Text);
                if (respuesta != "False")
                {
