<%@ Page Title="" Language="C#" MasterPageFile="~/Servicios.Master" AutoEventWireup="true" CodeBehind="ConceptosRelacionadosLite.aspx.cs" Inherits="MinsalWS.Pages.Servicio3.ConceptosRelacionadosLite" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width:100%;">
        ...
        <tr>
            <td>
                <asp:Label ID="lblCategoriaRelacion" Text="Categoría relación:" runat="server"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtCategoriaRelacion" Text="" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td>
