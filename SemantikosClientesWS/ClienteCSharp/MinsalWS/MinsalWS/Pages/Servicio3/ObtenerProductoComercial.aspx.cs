...
{
    public partial class ObtenerProductoComercial : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = busqueda.RespuestaObtenerProductoComercial(txtConcepto.Text, txtDescripcionId.Text);
                if (respuesta != "False")
                {
