...
{
    public partial class ObtenerFamiliaProducto : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = busqueda.RespuestaObtenerFamiliaProducto(txtConcepto.Text, txtDescripcionId.Text);
                if (respuesta != "False")
                {
