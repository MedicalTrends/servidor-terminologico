...
{
    public partial class ObtenerMedicamentoClinicoLite : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = busqueda.RespuestaObtenerMedicamentoClinicoLite(txtConcepto.Text, txtDescripcionId.Text);
                if (respuesta != "False")
                {
