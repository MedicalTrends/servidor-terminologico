...
{
    public partial class ObtenerProductoComercialConEnvaseLite : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = busqueda.RespuestaObtenerProductoComercialConEnvaseLite(txtConcepto.Text, txtDescripcionId.Text);
                if (respuesta != "False")
                {
