...
{
    public partial class ObtenerProductoComercialLite : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = busqueda.RespuestaObtenerProductoComercialLite(txtConcepto.Text, txtDescripcionId.Text);
                if (respuesta != "False")
                {
