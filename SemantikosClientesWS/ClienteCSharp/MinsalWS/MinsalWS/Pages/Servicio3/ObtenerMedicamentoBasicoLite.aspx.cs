...
{
    public partial class ObtenerMedicamentoBasicoLite : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = busqueda.RespuestaObtenerMedicamentoBasicoLite(txtConcepto.Text, txtDescripcionId.Text);
                if (respuesta != "False")
                {
