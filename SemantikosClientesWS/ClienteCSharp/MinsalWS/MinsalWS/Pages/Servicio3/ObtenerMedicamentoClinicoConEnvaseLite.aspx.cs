...
{
    public partial class ObtenerMedicamentoClinicoConEnvaseLite : System.Web.UI.Page
    {
        ...
        public bool ConsumirServicio()
        {
            try
            {
                ...
                respuesta = busqueda.RespuestaObtenerMedicamentoClinicoConEnvaseLite(txtConcepto.Text, txtDescripcionId.Text);
                if (respuesta != "False")
                {
