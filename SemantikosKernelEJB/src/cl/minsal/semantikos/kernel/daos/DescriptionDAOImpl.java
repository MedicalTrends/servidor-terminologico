...
public class DescriptionDAOImpl implements DescriptionDAO {
    ...
    public Description getDescriptionBy(long id) {
        ...
        try (Connection connection = DataSourceFactory.getInstance().getConnection();
            ...
            while (rs.next()) {
                description = createDescriptionFromResultSet(rs, null, true);
            }
    ...
    public List<Description> getDescriptionsByConcept(ConceptSMTK conceptSMTK) {
        ...
        try (Connection connection = DataSourceFactory.getInstance().getConnection();
            ...
            while (rs.next()) {
                Description description = createDescriptionFromResultSet(rs, conceptSMTK, false);
    ...
    public List<Description> searchDescriptionsByTerm(String term, Long[] categories, Long[] refsets) {
        ...
        try (Connection connection = DataSourceFactory.getInstance().getConnection();
            ...
            while (rs.next()) {
                Description description = createDescriptionFromResultSet(rs, null, false);
                descriptions.add(description);
            }
    ...
    public Description createDescriptionFromResultSet(ResultSet resultSet, ConceptSMTK conceptSMTK, boolean chargeDescriptions) throws SQLException {
        ...
        if (conceptSMTK == null) {
            if(conceptSMTKMap.containsKey(idConcept)) {
                ...
                conceptSMTK = conceptDAO.getConceptByID(idConcept, chargeDescriptions);
