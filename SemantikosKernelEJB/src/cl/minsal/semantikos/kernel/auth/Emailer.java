...
/**
 * <p>
 * {@link Emailer} contains all the business logic for the application, and also serves as the
...
public class Emailer implements Serializable {
    ...
    public Emailer(String to, String password, String link, String link2) {
        this.to = to;
    ...
    public void send() throws Exception
    {
        try {
            ...
            mySession = (Session)c.lookup("java:jboss/mail/Default");
