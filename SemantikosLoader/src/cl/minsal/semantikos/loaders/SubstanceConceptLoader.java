...
public class SubstanceConceptLoader extends EntityLoader {
    ...
    public void loadConceptFromFileLine(String line, User user) throws LoadException {
        ...
        boolean autogenerated = tokens[substanceConceptFields.get("CREAC_NOM")].equals("Autogenerado");

        Category category = CategoryFactory.getInstance().findCategoryByName("Fármacos - Sustancia");
        TagSMTK tagSMTK = TagSMTKFactory.getInstance().findTagSMTKByName("sustancias");
        ...
        long idConceptSCT = Long.parseLong(tokens[substanceConceptFields.get("SCT_ID")]);
