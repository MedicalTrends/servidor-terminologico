...
public class MBConceptLoader extends EntityLoader {
    ...
    public void loadConceptFromFileLine(String line, User user) throws LoadException {
        ...
        boolean autogenerated = tokens[mbConceptFields.get("CREAC_NOM")].equals("Autogenerado");
        ...
        long idConceptSCT = Long.parseLong(tokens[mbConceptFields.get("SCT_ID")]);
        ...
        relationshipDefinition = RelationshipDefinitionFactory.getInstance().findRelationshipDefinitionByName(TargetDefinition.SUSTANCIA);

        /*Recuperando Sustancias*/
        String substances = tokens[mbConceptFields.get("SUSTANCIA")];
        ...
        for (String substanceToken : substancesTokens) {
            ...
            BasicTypeValue order = new BasicTypeValue(Integer.parseInt(substanceTokens[1]));
